...
# Parsing Script – ARIA - Rev. B

This **Parsing** script is designed for the **ARIA** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – ARIA Rev. B

Este script de **Parsing** está diseñado para el modelo **ARIA** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
